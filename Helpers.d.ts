 ...
 * @returns {Buffer}
 */
export declare function generateRandomBytes(count: number): any;
/**
...
export declare function convertToLittle(buf: Buffer): any;
/**
...
export declare function returnBigInt(num: bigInt.BigInteger | string | number | bigint): any;
/**
 ...
 * @returns {Buffer}
 */
export declare function bufferXor(a: Buffer, b: Buffer): any;

...
export declare class MemorySession extends Session {
    ...
    load(): Promise<void>;
    delete(): void;
    _entityValuesToRow(id: bigInt.BigInteger | string, hash: bigInt.BigInteger | string, username: string, phone: string, name: string): any[];
    _entityToRow(e: any): any[] | undefined;
    _entitiesToRows(tlo: any): any[][];

...
export declare function _photoSizeByteCount(size: Api.TypePhotoSize): any;
 ...
 */
export declare function getInputChannel(entity: EntityLike): any;
/**
 ...
 * @returns {Buffer}
 */
export declare function strippedPhotoToJpg(stripped: Buffer): any;
/**
 ...
 * @param id
 */
export declare function parseID(id: string): any;

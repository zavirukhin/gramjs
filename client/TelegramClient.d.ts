...
export declare class TelegramClient extends TelegramBaseClient {
     ...
     * ```
     */
    downloadFile(inputLocation: Api.TypeInputFileLocation, fileParams?: downloadMethods.DownloadFileParamsV2): Promise<any>;
    /**
     ...
     * ```
     */
    downloadProfilePhoto(entity: EntityLike, downloadProfilePhotoParams?: downloadMethods.DownloadProfilePhotoParams): Promise<any>;
    /**
     ...
     * ```
     */
    downloadMedia(messageOrMedia: Api.Message | Api.TypeMessageMedia, downloadParams?: DownloadMediaInterface): Promise<any>;
    /**
